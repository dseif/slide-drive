...
var AudioJS = Class.extend({
  ...
  positionController: function(){
    ...
    this.controls.style.height = 15 + "px";
    this.controls.style.width = $( ".project-container" )[ 0 ].offsetWidth - this.playControl.offsetWidth - this.volumeControl.offsetWidth - this.timeControl.offsetWidth 
    - (this.getControlsPadding() * 6) + "px";
